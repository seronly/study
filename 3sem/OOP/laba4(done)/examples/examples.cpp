/* Создается класс Student. Формируется динамический массив объектов. 
При тестировании выводится:
сформированный список студентов,
...
//список студентов заданного факультетата и курса
{
    int i, k;
    char fac[20];
